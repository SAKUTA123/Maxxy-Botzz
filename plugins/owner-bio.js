...
⫹⫺ *🧮 Kelas* : ${global.kelas}
⫹⫺ *🧩 Hobby* : ${global.hobi}
⫹⫺ *💬 Sifat* : Asik Kalau Udah Kenal
⫹⫺ *🗺️ Tinggal* : ${global.tempat}
⫹⫺ *❤️ Waifu* : Suka Miku

⫹⫺ *📷 ɪɴsᴛᴀɢʀᴀᴍ* : ${linkig}
⫹⫺ *🤖 ʏᴏᴜᴛᴜʙᴇ* : ${linkyt}`
conn.sendButtonDoc(m.chat, teksbio, wm,'M͜͡E͜͡N͜͡U͜͡','.menu', ftroli, { gifPlayback: true, contextInfo: { externalAdReply: {title: namabot, body: date, sourceUrl: linkyt, thumbnail: fs.readFileSync('./img/ThumbnailMenu.jpg') }}})
}
